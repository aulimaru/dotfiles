...
(doom! :input
       ...
       (latex +cdlatex +fld +latexmk +lsp)             ; writing papers in Emacs has never been so fun
       ...
       (org +roam +gnuplot +present +pandoc +journal +pretty)               ; organize your plain life in plain text
